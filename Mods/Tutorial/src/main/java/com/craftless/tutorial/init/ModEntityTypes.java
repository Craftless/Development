...
import com.craftless.tutorial.entities.ExplosiveZombie;
...
public class ModEntityTypes
{
	...
	//Entity Types
		public static final RegistryObject<EntityType<ExplosiveZombie>> EXPLOSIVE_ZOMBIE = ENTITY_TYPES.register("explosive_zombie",
				() -> EntityType.Builder.create(ExplosiveZombie::new, EntityClassification.MONSTER)
				.size(0.6F, 1.95F)
				.func_233606_a_(8)
				.build(new ResourceLocation(Tutorial.MOD_ID, "hog").toString()));
