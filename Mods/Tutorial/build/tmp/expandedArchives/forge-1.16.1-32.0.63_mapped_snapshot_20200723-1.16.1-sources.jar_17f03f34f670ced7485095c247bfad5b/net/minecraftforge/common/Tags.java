...
public class Tags
{
    public static class Blocks
    {
        ...
        {
            return ForgeNetworkTagManager.defaulted(Registry.BLOCK_KEY, tag(name), Arrays.asList(values).stream().map(e -> e.getRegistryName()).collect(Collectors.toSet()));
        }
    }
    ...
    public static class Items
    {
        ...
        {
            return ForgeNetworkTagManager.defaulted(Registry.ITEM_KEY, tag(name), RegistryKey.func_240903_a_(Registry.BLOCK_KEY, parent.getName()));
        }
    }
}
